...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('https://fondosmil.com/fondo/21959.jpg');">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form autocomplete="off" role="form" class="text-start"  id="login"
                    action="?controlador=clientes&accion=validar" method="POST">
